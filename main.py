...
if response.status_code == 200:
   ...
   if places:
       ...
       for place in places:
           ...
           results.append({
               'نام تعمیرگاه': place.get('title', ''),
               'آدرس': place.get('address', ''),
               'شماره تماس': place.get('phone', ''),
               'امتیاز': place.get('rating', ''),
               'تعداد نظر': place.get('reviews', ''),
               'نوع مکان': place.get('type', ''),
               'لینک گوگل مپ': map_link
           })
